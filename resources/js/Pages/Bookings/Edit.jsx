...
export default function Edit({ booking, flightDays }) {
    const { data, setData, put, errors, reset } = useForm({
        ...
        take_of_time: booking.take_of_time || '',
        landing_time: booking.landing_time || '',
        landing_date: booking.landing_date || '',
    ...
    function handleSubmit(e) {
        e.preventDefault();
        put(route('bookings.update', booking.id)); // PUT request to update the booking
    }
